...
| 256      | `FLAG_CELL_FLAGS`               | No              | Yes             | The manifest contains Cell Flag registry or state metadata. Readers may ignore it for ordinary field reads; writers must preserve it. |
