...
| 512      | `FLAG_STABLE_FIELD_IDS`         | No              | Yes             | The manifest carries a persistent field-ID high-water mark that writers must use when allocating field IDs. See [Field IDs](schema.md#field-ids). |
