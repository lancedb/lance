...
| 64       | `FLAG_DATA_OVERLAY_FILES`       | Yes             | Yes             | Fragments carry data overlay files. Set by the commit that attaches the first overlay, cleared by the one that removes the last. |
