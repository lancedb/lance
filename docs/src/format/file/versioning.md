...
| 2.3 (unstable) | None                  | Any                   | Switches manifests to a single Lance file with top-level metadata sections and adds experimental encodings for upcoming features. |
