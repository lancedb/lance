...
public class DatasetTest {
  ...
  void testReplaceFieldConfig() {
    ...
    try (RootAllocator allocator = new RootAllocator(Long.MAX_VALUE)) {
      ...
      replaceMetadata.put("key1", "value1");
      replaceMetadata.put("key2", "value2");
      dataset.replaceFieldMetadata(Collections.singletonMap(field.getName(), replaceMetadata));
      assertEquals(2, dataset.version());
      ...
      Map<String, String> replaceConfig2 = new HashMap<>();
      replaceConfig2.put("key1", "value3");
      dataset.replaceFieldMetadata(Collections.singletonMap(field.getName(), replaceConfig2));
