...
impl BlockingDataset {
    ...
    pub fn open(
        ...
        let params = ReadParams {
            index_cache_size_bytes: index_cache_size_bytes.try_into().unwrap_or(0),
            metadata_cache_size_bytes: metadata_cache_size_bytes.try_into().unwrap_or(0),
...
fn inner_open_native<'local>(
    ...
    version_obj: JObject,    // Optional<Integer>
    block_size_obj: JObject, // Optional<Integer>
    index_cache_size: jlong,
    metadata_cache_size: jlong,
    storage_options_obj: JObject, // Map<String, String>
) -> Result<JObject<'local>> {
