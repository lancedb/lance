 ...
 *
 * <h3>Migration Guide from Legacy API</h3>
 *
 ...
 * }</pre>
 *
 * <h4>Key Benefits of New API:</h4>
 *
 * <ul>
 *   <li><strong>Table Metadata:</strong> New support for dataset-level metadata separate from
 *       schema
 *   <li><strong>Incremental Updates:</strong> Set {@code replace=false} to merge with existing
 *       metadata
 *   <li><strong>Full Replacement:</strong> Set {@code replace=true} to completely replace metadata
 *   <li><strong>Unified Pattern:</strong> All metadata types use the same UpdateMap structure
 *   <li><strong>Key Deletion:</strong> Use {@code null} values in updates map to delete keys
 * </ul>
 */
