...
public class CompactionTest {
      ...
      try (Dataset dataset = testDataset.write(4, 10)) {
        CompactionOptions options =
            CompactionOptions.builder()
                ...
                .withBlobRepackUtilizationThreshold(0.4f)
                .build();
        ...
        assertEquals(
            Optional.of(0.4f), plan.getCompactionOptions().getBlobRepackUtilizationThreshold());
        ...
        assertEquals(
            Optional.of(0.4f), task.getCompactionOptions().getBlobRepackUtilizationThreshold());
      }
    }
  }
  ...
  public void testDeserializeOptionsFromOlderVersion() throws Exception {
    ...
    assertEquals(Optional.empty(), options.getBlobRepackUtilizationThreshold());
  }
