...
pub struct FullZipScheduler {
    ...
    rep_index: Option<RepIndexDetails>,
    priority: u64,
    rows_in_page: u64,
...
impl FullZipScheduler {
    ...
    // In the simple case there is no repetition.  We just have large fixed-width
