...
impl ValueEncoder {
    ...
    fn simple_per_value_fsl(fsl: FixedSizeListBlock) -> Result<(PerValueDataBlock, CompressiveEncoding)> {
    ...
    fn nullable_per_value_fsl(fsl: FixedSizeListBlock) -> Result<(PerValueDataBlock, CompressiveEncoding)> {
