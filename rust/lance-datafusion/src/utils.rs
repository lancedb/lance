...
pub const SEARCH_PARTITIONS_ELAPSED_METRIC: &str = "search_partitions_elapsed";
pub const SEARCH_PARTITIONS_CALLS_METRIC: &str = "search_partitions_calls";
pub const SHARED_COARSE_QUANTIZER_FAST_PATH_METRIC: &str = "shared_coarse_quantizer_fast_path";
pub const COARSE_QUANTIZER_REUSED_SEGMENTS_METRIC: &str = "coarse_quantizer_reused_segments";
