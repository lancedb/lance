...
pub const FRAGMENTS_PLANNED_METRIC: &str = "fragments_planned";
pub const RANGES_PLANNED_METRIC: &str = "ranges_planned";
pub const ROWS_PLANNED_METRIC: &str = "rows_planned";
