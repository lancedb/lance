...
async fn build_dataset(
    ...
    for (column, index_type) in indices {
        ...
        // TODO: once supported by all indices, use `fragments_to_index` to make
        // sure each index covers (1) not the whole dataset and (2) different
        // parts of the dataset than other indices.
