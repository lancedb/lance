...
pub(crate) async fn commit_transaction(
    ...
    for attempt_i in 0..num_attempts {
        ...
        let old_manifest_stream = futures::stream::iter(target_version..=dataset.manifest.version)
            .map(|version| {
        ...
        let manifests_to_check = if attempt_i == 0 {
            old_manifest_stream.take_while(|res| {
        ...
        manifests_to_check.try_for_each(|(other_version, other_transaction)| {
