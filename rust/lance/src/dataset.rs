...
use crate::dataset::schema_evolution::AddColumnsBuilder;
...
impl Dataset {
    ...
    pub async fn add_columns(
        ...
        schema_evolution::add_columns(self, transforms, read_columns, batch_size, None).await
    }

    /// add add_columns_builder for optional properties
    pub fn add_columns_builder(
        &mut self,
        transforms: impl Into<NewColumnTransform>,
    ) -> AddColumnsBuilder<'_> {
        AddColumnsBuilder::new(self, transforms.into())
    }
