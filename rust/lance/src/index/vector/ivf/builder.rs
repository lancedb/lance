...
use lance_index::vector::{
    hnsw::builder::HnswBuildParams, ivf::shuffler::shuffle_dataset, pq::ProductQuantizer,
};
use lance_io::{stream::RecordBatchStream, traits::Writer};
use lance_linalg::distance::MetricType;

use crate::{
    index::vector::ivf::{io::write_pq_index_partitions, Ivf},
    Dataset,
};
...
pub(super) async fn build_pq_partitions(
    ...
    write_pq_index_partitions(writer, ivf, Some(stream), None).await?;
