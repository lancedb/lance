...
//! - For small datasets (<200KB): exact join key mapping
//! - For large datasets (>=200KB): probabilistic Bloom Filter
//!
//! The conflict detection works by:
//! 1. Collecting join keys during merge insert operations
...
pub use join_key::{FilterType, JoinKeyBloomFilter, JoinKeyMetadata, JoinKeyValue};
