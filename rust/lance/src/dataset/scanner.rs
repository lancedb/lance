...
use crate::io::exec::{new_knn_exec, FilterPlan, PreFilterSource};
use crate::io::exec::{
    KNNFlatExec, LancePushdownScanExec, LanceScanExec, Planner, ProjectionExec, ScanConfig,
    TakeExec,
};
...
impl Scanner {
    ...
    async fn ann(
        ...
        println!(
            "KNN inner search schema: {:#?}",
            inner_fanout_search.schema()
        );
