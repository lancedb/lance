...
use lance_index::scalar::inverted::query::{
    fill_fts_query_column, FtsQuery, FtsQueryNode, FtsSearchParams, MatchQuery,
};
...
impl Scanner {
    ...
    ///     .into_stream();
    /// ```
    pub fn query_filter(&mut self, filter: QueryFilter) -> Result<&mut Self> {
