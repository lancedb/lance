...
/// The default compaction planner implementation.
///
/// This planner uses the original Lance compaction strategy:
/// - Compacts fragments with fewer rows than `target_rows_per_fragment`
/// - Materializes deletions when deletion percentage exceeds threshold
/// - Respects index boundaries (cannot mix indexed and non-indexed fragments)
/// - Groups adjacent fragments for compaction
