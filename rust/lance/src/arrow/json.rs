...
use std::borrow::Cow;
use utoipa::openapi::{ArrayBuilder, ObjectBuilder, Ref, RefOr, Schema as OpenApiSchema};
...
impl PartialSchema for JsonDataType {
    fn schema() -> RefOr<OpenApiSchema> {
        RefOr::T(OpenApiSchema::Object(
            ObjectBuilder::new()
                .description(Some(
                    "JSON representation of an Apache Arrow DataType".to_string(),
                ))
                .property(
                    "type",
                    ObjectBuilder::new()
                ...
                .property(
                    ...
                    ArrayBuilder::new()
                        ...
                        .description(Some(
                            "Fields for complex types like Struct, Union, etc.".to_string(),
                        )),
                )
                .property(
                    "length",
