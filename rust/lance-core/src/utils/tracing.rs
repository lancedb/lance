...
pub const NEW_VERSION_EVENT: &str = "new_version";
pub const OPEN_EVENT: &str = "open";
pub const DROP_COLUMN_EVENT: &str = "drop_column";
pub const DELETE_EVENT: &str = "delete";
pub const COMPACTION_EVENT: &str = "compaction";
pub const CLEANUP_EVENT: &str = "cleanup";
