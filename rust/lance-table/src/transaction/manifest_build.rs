...
mod tests {
    ...
    fn test_data_replacement_preserves_new_blob_reuse_index() {
        ...
        let index = Arc::new(BlobReuseIndex {
    ...
    fn blob_reuse_index_is_immutable_by_physical_data_file_identity() {
        ...
        let left = Arc::new(BlobReuseIndex {
            sources: vec![
                BlobReuseSource {
                    base_id: None,
        ...
        let changed_index = Arc::make_mut(
            Arc::make_mut(&mut changed.fragments)[0].files[0]
                .blob_reuse_index
                .as_mut()
                .unwrap(),
        );
        changed_index.sources[0].physical_ids[0] = 9;
        let err =
