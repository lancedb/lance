    ...
    pub mod avx {
        ...
        pub fn l2_f32(from: &[f32], to: &[f32]) -> f32 {
            unsafe {
                ...
                // Remaining elements
                let remained_len = from.len() / INSTRUCTION_WIDTH * INSTRUCTION_WIDTH;
