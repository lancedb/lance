...
/// Search a bounded compound FTS query over multiple indexed columns.
///
...
mod tests {
    ...
    use crate::scalar::inverted::query::{BooleanQuery, MatchQuery, Occur, PhraseQuery};
    use crate::scalar::inverted::tokenizer::document_tokenizer::DocType;
    use crate::scalar::inverted::{
        CompressedPostingList, LEGACY_BLOCK_SIZE, PlainPostingList, PostingList, PostingTailCodec,
    };
    ...
    fn stages_only_selective_single_leaf_generators_with_probe_work() {
        ...
        let analysis = CompoundPlanAnalysis {
            ...
            leaf_roles: vec![Default::default(); 2],
        };
        assert_eq!(
