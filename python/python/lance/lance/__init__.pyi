...
class LanceFileReader:
    ...
    def read_all(
        self, batch_size: int, batch_readahead: int, columns: Optional[List[str]] = None
    ) -> pa.RecordBatchReader: ...
    def read_range(
        self, start: int, num_rows: int, batch_size: int, batch_readahead: int, columns: Optional[List[str]] = None
    ) -> pa.RecordBatchReader: ...
    def take_rows(
        self, indices: List[int], batch_size: int, batch_readahead: int, columns: Optional[List[str]] = None
    ) -> pa.RecordBatchReader: ...
