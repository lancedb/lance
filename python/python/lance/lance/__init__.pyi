...
class _Dataset:
    ...
    def merge(
        ...
        left_on: str,
        right_on: str,
        cell_flags: Optional[Dict[str, Dict[str, bool]]] = None,
    ): ...
...
class _MergeInsertBuilder:
    ...
    def set_matched_cell_flag(self, field: str, name: str, value: bool) -> Self: ...
    def set_inserted_cell_flag(self, field: str, name: str, value: bool) -> Self: ...
