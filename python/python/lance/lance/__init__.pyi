...
class PackedBlobWriter:
    ...
    def finish(self) -> List[PreparedBlobValue]: ...
...
class DedicatedBlobWriter:
    ...
    def finish(self) -> PreparedBlobValue: ...

class LanceBlobWriter:
    @property
    def field(self) -> pa.Field: ...
    def new_packed(self) -> PackedBlobWriter: ...
    def new_dedicated(self) -> DedicatedBlobWriter: ...
    def load_packed(
        self, blob_id: int, offsets: List[int], sizes: List[int]
    ) -> List[PreparedBlobValue]: ...
    def load_dedicated(self, blob_id: int) -> PreparedBlobValue: ...
    def push(self, value: PreparedBlobValue) -> None: ...
    def extend(self, values: List[PreparedBlobValue]) -> None: ...
    def push_inline(self, data: bytes) -> None: ...
    def push_null(self) -> None: ...
    def finish(self) -> pa.Array: ...

class LanceBlobSession:
    def __init__(
        self,
        data_file_path: str,
    ...
    @property
    def data_file_key(self) -> str: ...
    def open_writer(self, column: str) -> LanceBlobWriter: ...
    def blob_path(self, blob_id: int) -> str: ...
