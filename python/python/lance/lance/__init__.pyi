...
from typing import Any, Dict, Iterable, Iterator, List, Optional, Sequence, Set, Tuple, TypedDict, Union

from ..dataset import AlterColumn, ExecuteResult, Index, OperationDict, Tag, Transaction, UpdateResult, Version
...
class _Dataset:
    ...
    def add_columns_from_reader(self, reader: pa.RecordBatchReader, batch_size: Optional[int] = None):
        ...
...
class _MergeInsertBuilder:
    ...
    def when_matched_update_all(self,
        ...
        ...
    def when_not_matched_insert_all(self) -> _MergeInsertBuilder:
        ...
    def when_not_matched_by_source_delete(self, expr: Optional[str] = None) -> _MergeInsertBuilder:
        ...
...
class _Operation:
    ...
    @staticmethod
    def append(fragments: List[_FragmentMetadata]) -> _Operation:
        ...

    @staticmethod
    def delete(
        updated_fragments: List[_FragmentMetadata],
    ...
    @staticmethod
    def merge(fragments: List[_FragmentMetadata], schema: LanceSchema) -> _Operation:
        ...

    @staticmethod
    def restore(version: int) -> _Operation:
        ...

    @staticmethod
    def rewrite(
        groups: List[_RewriteGroup],
        rewritten_indices: List[_RewrittenIndex]
    ) -> _Operation:
        ...
...
class _RewriteGroup:
    def __init__(self, old_fragments: List[_FragmentMetadata], new_fragments: List[_FragmentMetadata]) -> None: ...

class _RewrittenIndex:
    def __init__(self, old_index: str, new_index: str) -> None: ...
...
class _Fragment:
    ...
    def add_columns_from_reader(
        ...
        reader: ReaderLike,
        batch_size: Optional[int],
    ) -> Tuple[_FragmentMetadata, LanceSchema]:
        ...
    ...
    def data_files(self) -> List[_DataFile]:
        ...
...
class _FragmentMetadata:
    @staticmethod
    def from_json(payload: str) -> _FragmentMetadata:
        ...
...
class _KMeans:
    ...
    def centroids(self) -> Union[pa.FixedShapeTensorType, pa.FixedSizeListType | None]:
        ...
