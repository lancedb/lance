...
class _Dataset:
    ...
    def open_vector_index_handle(self, index_name: str) -> "_VectorIndexHandle": ...
...
class _VectorIndexHandle:
    ...
    def as_ivf(self) -> "_IvfIndexHandle": ...

class _IvfIndexHandle:
    @property
    def metric_type(self) -> str: ...
    @property
    def dimension(self) -> int: ...
    def read_centroids(self) -> pa.FixedSizeListArray: ...
    def read_pq_codebook(self) -> "Optional[Dict[str, Any]]": ...
