...
class DatasetOptimizer:
    ...
    def compact_files(
        ...
        *,
        ...
        blob_repack_active_ratio_threshold: Optional[float] = None,
        ...
        blob_repack_active_ratio_threshold: float, optional
            Repack a fragment's Packed Blob v2 sidecars when active rows divided
            by physical rows is below this threshold. Must be between 0.0 and
            1.0. If not specified, uses the manifest config value, or 0.3.
        ...
        opts = {
            ...
            for k, v in dict(
                ...
                blob_repack_active_ratio_threshold=blob_repack_active_ratio_threshold,
