...
# Adapted from https://github.com/pola-rs/polars/blob/e3a491e8e5d8d50f3f5d0420a122a74e1e8194a4/py-polars/polars/dependencies.py
...
def _check_for_numpy(obj: Any) -> bool:
    return _NUMPY_INSTALLED and _might_be(cast(Hashable, type(obj)), "numpy")


def _check_for_pandas(obj: Any) -> bool:
    return _PANDAS_INSTALLED and _might_be(cast(Hashable, type(obj)), "pandas")
