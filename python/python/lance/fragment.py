...
class LanceFragment(pa.dataset.Fragment):
    ...
    def scanner(
        ...
        *,
        ...
        excluded_scalar_index_names: Optional[List[str]] = None,
        ...
        s = self._fragment.scanner(
            ...
            excluded_scalar_index_names=excluded_scalar_index_names,
        ...
        snapshot = {
            ...
            "_excluded_scalar_index_names": excluded_scalar_index_names,
